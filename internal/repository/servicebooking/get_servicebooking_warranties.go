...
func (r *repository) GetServiceBookingWarranties(ctx context.Context, req servicebooking.GetServiceBookingWarranty) ([]domain.ServiceBookingWarranty, error) {
	var model domain.ServiceBookingWarranty
	var result []domain.ServiceBookingWarranty
