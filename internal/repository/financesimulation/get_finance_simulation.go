...
func (r *repository) GetFinanceSimulation(ctx context.Context, req leads.GetFinanceSimulationRequest) (domain.LeadsFinanceSimulation, error) {
	var model domain.LeadsFinanceSimulation
