...
func (dto *ReminderDetail) ToDomainCustomerReminder() domain.CustomerReminder {
	...
	entity := domain.CustomerReminder{
		...
		AutoReminderStatus:      utils.ToPointer(dto.AutoReminderStatus),
		ReminderMessage:         utils.ToPointer(dto.ReminderMessage),
		PriorityCall:            utils.ToPointer(dto.PriorityCall),
		ExtendedWarrantyStatus:  utils.ToPointer(dto.ExtendedWarrantyStatus),
		CustomerHabit:           utils.ToPointer(dto.CustomerHabit),
		LastHabit:               utils.ToPointer(dto.LastHabit),
		NextServiceStatus:       utils.ToPointer(dto.NextServiceStatus),
		NCSStatus:               utils.ToPointer(dto.NCSStatus),
		ProgramTab:              utils.ToPointer(dto.ProgramTab),
		NextServiceStage:        utils.ToPointer(dto.NextServiceStage),
		CreatedAt:               now,
		CreatedBy:               utils.ToPointer(constants.System),
		UpdatedAt:               utils.ToPointer(now),
		UpdatedBy:               utils.ToPointer(constants.System),
	}
