...
func NewLeadsRequest(leads domain.Leads) LeadsRequest {
	return LeadsRequest{
		...
		LeadsPreferenceContactTimeStart: utils.ToValue(leads.LeadsPreferenceContactTimeStart),
		LeadsPreferenceContactTimeEnd:   utils.ToValue(leads.LeadsPreferenceContactTimeEnd),
		...
		LeadsScore: Score{
			...
			Parameter: ScoreParameter{
				PurchasePlanCriteria:    utils.ToValue(leads.PurchasePlanCriteria),
				PaymentPreferCriteria:   utils.ToValue(leads.PaymentPreferCriteria),
				NegotiationCriteria:     utils.ToValue(leads.NegotiationCriteria),
				TestDriveCriteria:       utils.ToValue(leads.TestDriveCriteria),
				TradeInCriteria:         utils.ToValue(leads.TradeInCriteria),
				BrowsingHistoryCriteria: utils.ToValue(leads.BrowsingHistoryCriteria),
				VehicleAgeCriteria:      utils.ToValue(leads.VehicleAgeCriteria),
			},
		},
	}
}
...
func (be *LeadsRequest) ToDomain(customerID string) domain.Leads {
	return domain.Leads{
		...
		LeadsPreferenceContactTimeStart: utils.ToPointer(be.LeadsPreferenceContactTimeStart),
		LeadsPreferenceContactTimeEnd:   utils.ToPointer(be.LeadsPreferenceContactTimeEnd),
		...
		PurchasePlanCriteria:            utils.ToPointer(be.LeadsScore.Parameter.PurchasePlanCriteria),
		PaymentPreferCriteria:           utils.ToPointer(be.LeadsScore.Parameter.PaymentPreferCriteria),
		TestDriveCriteria:               utils.ToPointer(be.LeadsScore.Parameter.TestDriveCriteria),
		TradeInCriteria:                 utils.ToPointer(be.LeadsScore.Parameter.TradeInCriteria),
		BrowsingHistoryCriteria:         utils.ToPointer(be.LeadsScore.Parameter.BrowsingHistoryCriteria),
		VehicleAgeCriteria:              utils.ToPointer(be.LeadsScore.Parameter.VehicleAgeCriteria),
		NegotiationCriteria:             utils.ToPointer(be.LeadsScore.Parameter.NegotiationCriteria),
		CreatedAt:                       time.Now(),
