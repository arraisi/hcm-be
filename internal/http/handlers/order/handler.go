...
//go:generate mockgen -package=salesorder -source=handler.go -destination=handler_mock_test.go
import (
	"context"
...
type Service interface {
	TrackOrderStatus(ctx context.Context, request order.TrackOrderStatusEvent) error
}
