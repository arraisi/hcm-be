...
func TestConfirmServiceBooking_Success(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "/api/v1/webhooks/service-booking/"+serviceBookingID+"?employee_id="+employeeID, nil)
...
func TestConfirmServiceBooking_MissingServiceBookingID(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "/api/v1/webhooks/service-booking/?employee_id=test-employee-id", nil)
	w := httptest.NewRecorder()
...
func TestConfirmServiceBooking_MissingEmployeeID(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPut, "/api/v1/webhooks/service-booking/"+serviceBookingID, nil)
	w := httptest.NewRecorder()
