...
// Package oneaccess is a generated GoMock package.
package oneaccess
...
import (
	...
	oneaccess "github.com/arraisi/hcm-be/internal/domain/dto/oneaccess"
...
// CreateOneAccess mocks base method.
func (m *MockService) CreateOneAccess(ctx context.Context, request oneaccess.Request) error {
	m.ctrl.T.Helper()
...
// CreateOneAccess indicates an expected call of CreateOneAccess.
func (mr *MockServiceMockRecorder) CreateOneAccess(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
