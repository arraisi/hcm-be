...
//go:generate mockgen -package=customerreminder -source=handler.go -destination=handler_mock_test.go
import (
	"context"
...
type Service interface {
	CreateCustomerReminder(ctx context.Context, request customerreminder.Request) error
}
